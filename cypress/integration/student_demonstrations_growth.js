describe('Student competency growth calculation test', () => {
    ...
    it('compare growth calculations', () => {
        cy.readFile('cypress/fixtures/growth-calculations.json').then((growthCalculationsByStudent) => {
                            ...
                            cy.wait('@studentCompetencyData')
                                ...
                                .then(() => {
                                    ...
                                    studentCompetencySuffixes.forEach((studentCompetencySuffix) => {
                                        ...
                                        cy.get('li.slate-demonstrations-student-competencycard').then(() => {
                                            ...
                                            compareCompetencyValues(
                                                ...
                                                card.id,
                                                growthCalculationsByStudent[studentUsername][studentContentArea][studentCompetencySuffix]
                                            );
                                        });
                                    });
                                });
