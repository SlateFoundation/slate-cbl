        ...
        cy.withExt().then(({ extQuerySelector }) => {
            ...
            cy.get("#" + todoList.id)
                ...
                .should(($todoListSection) => {
                    expect($todoListSection.length).to.equal(3);
                });
                ...
                .then(() => {
                    ...
                    cy.wait("@studentTasksData").should((xhr) => {
                        ...
                        cy.get("#" + currentTasksTree.id).should(($tasksTree) => {
                            expect($tasksTree.find("li.slate-tasktree-item").length).to.equal(4);
                        });
                    });
                                ...
                                cy.wait("@studentTasksData")
                                    ...
                                    .then(() => {
                                        ...
                                        cy.wait("@studentTasksData")
                                            ...
                                            .and(() => {
                                                cy.get("#" + currentTasksTree.id).should(
                                                    ($tasksTree) => {
                                                        expect(
                                                            $tasksTree.find(
                                                                "li.slate-tasktree-item"
                                                            ).length
                                                        ).to.equal(length);
                                                    }
                                                );
