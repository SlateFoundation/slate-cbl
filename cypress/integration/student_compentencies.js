describe('Teacher student competencies test', () => {
    ...
    it('View student competencies dashboard as teacher', () => {
        ...
        cy.withExt().then(({ Ext, extQuerySelector, extQuerySelectorAll }) => {
            ...
            var rubricSelector = extQuerySelector(
                'slate-cbl-contentareaselector'
            );
            ...
            var studentSelector = extQuerySelector(
                'slate-cbl-studentslistselector'
            );
            ...
            cy.get('.slate-studentcompetencies-admin-grid').contains(
                'Student Slate'
            );
        });
    });
