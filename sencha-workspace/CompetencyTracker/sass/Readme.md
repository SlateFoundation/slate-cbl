...
folder are mapped to the application's root namespace, 'CompetencyTracker'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "CompetencyTracker"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'CompetencyTracker' in the same way
as `"CompetencyTracker/sass/src"`.
