StartTest(function(t) {
    ...
    t.chain(
        ...
        function (next) {
            ...
            t.doubleClick('testgrid => .x-grid-row:contains(601_siesta_ui_passing.t.js?1)', function () {})
        },
        function (next) {
            Harness.on('testfinalize', next, null, { single : true })
            
            t.doubleClick('testgrid => .x-grid-row:contains(601_siesta_ui_passing.t.js?2)', function () {})
        },
        {
            action      : 'click',
            target      : 'testgrid => .x-grid-row:contains(601_siesta_ui_passing.t.js?1)'
        },
        function () {
