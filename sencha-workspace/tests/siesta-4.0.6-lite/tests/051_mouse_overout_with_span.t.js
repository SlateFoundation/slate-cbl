StartTest(function(t) {
    ...
    var isSafari            = /safari/i.exec(navigator.userAgent)
    var hasMouseEnter       = $.browser.msie || $.browser.mozilla && parseInt($.browser.version) >= 10 || isChrome && Number(isChrome[ 1 ]) >= 30 || isSafari
