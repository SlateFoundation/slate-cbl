...
folder are mapped to the application's root namespace, 'SlateDemonstrationsTeacher'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SlateDemonstrationsTeacher"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SlateDemonstrationsTeacher' in the same way
as `"SlateDemonstrationsTeacher/sass/src"`.
