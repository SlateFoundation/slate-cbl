...
folder are mapped to the application's root namespace, 'SlateDemonstrationsStudent'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SlateDemonstrationsStudent"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SlateDemonstrationsStudent' in the same way
as `"SlateDemonstrationsStudent/sass/src"`.
