...
class Stream implements StreamInterface
{
    ...
    public function seek($offset, $whence = SEEK_SET)
    {
        ...
        if (fseek($this->stream, $offset, $whence) === -1) {
            throw new Exception('Unable to seek to stream position '
    ...
    public function read($length)
    {
        ...
        if (!$this->readable) {
            throw new Exception('Cannot read from non-readable stream');
        }
        if ($length < 0) {
            throw new Exception('Length parameter cannot be negative');
        }
    ...
    public function write($string)
    {
        ...
        if (!$this->writable) {
            throw new Exception('Cannot write to a non-writable stream');
        }
