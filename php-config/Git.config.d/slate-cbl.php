...
Git::$repositories['slate-cbl'] = [
    ...
    'trees' => [
        ...
        'sencha-workspace/SlateDemonstrationsStudent' => [ 'exclude' => [ '#^/resources/slate-frame#' ] ],
        'sencha-workspace/SlateDemonstrationsTeacher' => [ 'exclude' => [ '#^/resources/slate-frame#' ] ],
        'sencha-workspace/SlateStudentCompetenciesAdmin' => [ 'exclude' => [ '#^/resources/slate-frame#' ] ],
        'sencha-workspace/SlateTasksManager' => [ 'exclude' => [ '#^/resources/slate-frame#' ] ],
        'sencha-workspace/SlateTasksStudent' => [ 'exclude' => [ '#^/resources/slate-frame#' ] ],
        'sencha-workspace/SlateTasksTeacher' => [ 'exclude' => [ '#^/resources/slate-frame#' ] ],
        'site-root/cbl',
